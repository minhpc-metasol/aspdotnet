...
namespace Metasol.Repository;

public partial class MetashopContext : DbContext
{
    public MetashopContext()
    {
    }

    public MetashopContext(DbContextOptions<MetashopContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=mssql.metasol.vn;Initial Catalog=Metashop;User ID=sa;Password=bhfnsONElqyEao8;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
